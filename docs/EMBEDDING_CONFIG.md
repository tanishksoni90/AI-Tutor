...
- **Production**: Google Gemini (1536 dimensions)
...
```bash
# In Qdrant
docker exec -it qdrant-container qdrant-cli collection delete course_knowledge
```
...
- Better quality, higher dimensions
